  ...
  const data = [
    {
      ...
      content: (
        <div>
          <p className="text-violet-50 dark:text-neutral-200 text-xs md:text-sm font-normal mb-8 font-general">
            A Timeline of Our Recent Performances
          </p>
    ...
    },
    {
      ...
      content: (
        <div>
          <p className="text-neutral-200 dark:text-neutral-200 text-xs md:text-sm font-general mb-4">
            We Did nothing all year ???
          </p>
          <div className="grid grid-cols-2 gap-4">
            <Image
    ...
    },
    {
      ...
      content: (
        <div>
          <p className="text-neutral-200 dark:text-neutral-200 text-xs md:text-sm font-general mb-4">
            Now we in ancient territory, gottas hit up the dino uncs for this
            info.
          </p>
          <div className="grid grid-cols-2 gap-4">
            <Image
